...
%These two lines define how wide your signal is and how much data you try to send per slot
...
channel.NumTransmitAntennas = nTxAnts;
channel.NumReceiveAntennas = nRxAnts;
% Not really necessary but just to ensure that we are testing the right
% SNRdb
...
for nSlot = 0:totalNoSlots-1
    ...
    for layerIdx = 1:pdsch.NumLayers
        ...
        % Change has been made here to know what was sent, to measure
        % actual distortion
...
fprintf('Retransmission Rate: %.2f%%\n', ...
    retransmissionRate = totalRetransmissions / max(1, totalInitialTransmissions) * 100);
