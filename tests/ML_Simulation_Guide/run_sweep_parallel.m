...
% LATENCY RUNS: 
SNRdB_vals          = [0 2 4 6 8];%2 4 6 8 10 12 14 16 18 10 20 22
Modulation_vals     = {"QPSK", "16QAM", "64QAM", "256QAM", "1024QAM"}; %"16QAM","64QAM","256QAM","1024QAM"
NHARQProcesses_vals = [1 2]; %[8 12 16 20 24]; 
...
numWorkers = 16;   % change to 3 if desired
